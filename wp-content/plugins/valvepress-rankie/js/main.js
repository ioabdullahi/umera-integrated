...
jQuery(document)
    .ready(
        function () {
            ...
            // Search button
            jQuery('#wp_keyword_tool_search_btn').on('click' , function () {
                        var keyword = jQuery(
            ...
            // Clean Button
            jQuery('#wp_keyword_tool_clean').on('click' ,function () {
                                ...
                                function (data) {
                                    ...
                                    if (list.length == 0) {
                                        ...
                                        for (var i = 0; i < list.length; i++) {
                                            ...
                                            if( jQuery('input[value="' + list[i] +  '"]').length == 0 ){
            ...
            // add tags button
            jQuery('#wp_keyword_tool_tag_btn').on('click' , function () {
            ...
            // Watch Keywords btn
            jQuery('#wp_keyword_tool_density_btn').on('click' ,function () {
            ...
            jQuery('#wp_keyword_tool_list_btn').on('click' , function(){
            	var txtList='';
             ...
             */
            jQuery('#wp_keyword_tool_check').on('click',function () {
             ...
             * what density btn
             */
            jQuery('#wp_keyword_tool_density_info').on('click' , function () {
            ...
            jQuery('.wp_keyword_tool_itm .ntdelbutton').on('click' ,function(){
