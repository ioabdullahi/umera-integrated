 ...
 * Module Class
 */
class ACF_Taxonomy extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Taxonomy';
		$this->module_title = __( 'Taxonomy', 'lc-acf-integration' );
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'taxonomy' );
			...
			$fields = lcacf_get_all_fields_by_group( 'taxonomy' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-taxonomy',
			...
			array(
				...
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-taxonomy li',
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-taxonomy li a',
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-taxonomy li a:hover',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-taxonomy lc-acf-module-taxonomy-<?php echo $options['format']; ?>">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_taxonomy' );

function lcacf_init_taxonomy() {
    return dslc_register_module( 'ACF_Taxonomy' );
}
