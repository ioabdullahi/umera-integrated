 ...
 * Module Class
 */
class ACF_Relationship extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Relationship';
		$this->module_title = __( 'Relationship', 'lc-acf-integration' );
		$this->module_icon = 'th';
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'relationship' );
			...
			$fields = lcacf_get_all_fields_by_group( 'relationship' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-relationship',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			),
			array(
				'label' => __( 'Format', 'lc-acf-integration' ),
				'id' => 'format',
				'std' => 'horizontal',
				'type' => 'select',
				'choices' => array(
					array(
						'label' => __( 'Horizontal', 'lc-acf-integration' ),
						'value' => 'horizontal',
					),
					array(
						'label' => __( 'Vertical', 'lc-acf-integration' ),
						'value' => 'vertical',
					),
				),
				'section' => 'styling',
			...
			array(
				...
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-relationship li',
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-relationship li a',
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-relationship li a:hover',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-relationship lc-acf-module-relationship-<?php echo $options['format']; ?>">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_relationship' );

function lcacf_init_relationship() {
    return dslc_register_module( 'ACF_Relationship' );
}
