 ...
 * Module Class
 */
class ACF_User extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_User';
		$this->module_title = __( 'User', 'lc-acf-integration' );
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'user' );
			...
			$fields = lcacf_get_all_fields_by_group( 'user' );
		...
		$dslc_options = array(
			...
			array(
				'label'   => __( 'Display name as', 'lc-acf-integration' ),
				'id'      => 'display_name',
				'std'     => 'nickname',
				'type'    => 'select',
				'choices' => array(
					array(
						'label' => __( 'Nickname', 'lc-acf-integration' ),
						'value' => 'nickname',
					),
					array(
						'label' => __( 'Name', 'lc-acf-integration' ),
						'value' => 'name',
					),
				),
				'section' => 'styling',
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-user',
			...
			array(
				...
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-user li',
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-user li a',
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-user li a:hover',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-user lc-acf-module-user-<?php echo $options['format']; ?>">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_user' );

function lcacf_init_user() {
    return dslc_register_module( 'ACF_User' );
}
