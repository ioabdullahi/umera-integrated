 ...
 * Module Class
 */
class ACF_Post_Object extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Post_Object';
		$this->module_title = __( 'Post Object', 'lc-acf-integration' );
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'post_object' );
			...
			$fields = lcacf_get_all_fields_by_group( 'post_object' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-post-object',
			...
			array(
				...
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-post-object li',
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-post-object li a',
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-post-object li a:hover',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-post-object lc-acf-module-post-object-<?php echo $options['format']; ?>">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_post_object' );

function lcacf_init_post_object() {
    return dslc_register_module( 'ACF_Post_Object' );
}
