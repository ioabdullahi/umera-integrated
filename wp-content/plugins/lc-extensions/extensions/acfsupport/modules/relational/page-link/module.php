 ...
 * Module Class
 */
class ACF_Page_Link extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Page_Link';
		$this->module_title = __( 'Page Link', 'lc-acf-integration' );
		$this->module_icon = 'link';
		$this->module_category = 'ACF - Relational';
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'page_link' );
			...
			$fields = lcacf_get_all_fields_by_group( 'page_link' );
		...
		$dslc_options = array(
			...
			array(
				'label' => __( 'Display as', 'lc-acf-integration' ),
				'id' => 'display',
				'std' => 'link',
				'type' => 'select',
				'choices' => array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-page-link',
			...
			array(
				...
				array(
					'label' => __( 'Color', 'lc-acf-integration' ),
					'id' => 'css_typography_link_color',
					'std' => '',
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-page-link a',
				...
				array(
					...
					'id' => 'css_typography_link_color_hover',
					'std' => '',
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-page-link a:hover',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
			...
			array(
				...
				'id' => 'css_button_bg_group',
				'type' => 'group',
				'action' => 'open',
				'section' => 'styling',
				'tab' => __( 'Button', 'lc-acf-integration' ),
			),
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lcacf-button a',
					'affect_on_change_rule' => 'background-color',
					'section' => 'styling',
					'tab' => __( 'Button', 'lc-acf-integration' ),
				),
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lcacf-button a:hover',
					'affect_on_change_rule' => 'background-color',
					'section' => 'styling',
					'tab' => __( 'Button', 'lc-acf-integration' ),
				),
			...
			array(
				...
				'section' => 'styling',
				'tab' => __( 'Button - Icon', 'live-composer-page-builder' ),
			),
			array(
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lcacf-button a .dslc-icon',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Button - Icon', 'live-composer-page-builder' ),
			),
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lcacf-button a:hover .dslc-icon',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Button - Icon', 'live-composer-page-builder' ),
			),
			...
			array(
				'label' => __( 'Button - Margin', 'lc-acf-integration' ),
			...
			array(
				'label' => __( 'Button - Padding', 'lc-acf-integration' ),
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-page-link">
		<?php
		...
		$icon_pos = $options['icon_pos'];
		$button_icon_id = $options['button_icon_id'];
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_page_link' );

function lcacf_init_page_link() {
    return dslc_register_module( 'ACF_Page_Link' );
}
