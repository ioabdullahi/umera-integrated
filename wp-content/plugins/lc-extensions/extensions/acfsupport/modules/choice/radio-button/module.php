 ...
 * Module Class
 */
class ACF_Radio_Button extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Radio_Button';
		$this->module_title = __( 'Radion Button', 'lc-acf-integration' );
		$this->module_icon = 'ok-circle';
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'radio' );
			...
			$fields = lcacf_get_all_fields_by_group( 'radio' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-radio-button',
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-radio-button span.label',
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-radio-button">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_radio_button' );

function lcacf_init_radio_button() {
    return dslc_register_module( 'ACF_Radio_Button' );
}
