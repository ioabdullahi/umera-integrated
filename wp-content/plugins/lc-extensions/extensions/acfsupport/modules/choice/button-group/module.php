 ...
 * Module Class
 */
class ACF_Button_Group extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Button_Group';
		$this->module_title = __( 'Button Group', 'lc-acf-integration' );
		$this->module_icon = 'check';
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'button_group' );
			...
			$fields = lcacf_get_all_fields_by_group( 'button_group' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-button-group',
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-button-group span.label',
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-button-group">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_button_group' );

function lcacf_init_button_group() {
    return dslc_register_module( 'ACF_Button_Group' );
}
