 ...
 * Module Class
 */
class ACF_Select extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Select';
		$this->module_title = __( 'Select', 'lc-acf-integration' );
		$this->module_icon = 'reorder';
		$this->module_category = 'ACF - Choice';
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'select' );
			...
			$fields = lcacf_get_all_fields_by_group( 'select' );
		...
		$dslc_options = array(
			...
			array(
				...
				'choices' => array(
					array(
						'label' => __( 'Single Line', 'live-composer-page-builder' ),
						'value' => 'single_line',
					),
					array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-select',
			...
			array(
				...
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-select li',
			...
			array(
				...
				'id' => 'css_label_font_group',
				'type' => 'group',
				'action' => 'open',
				'section' => 'styling',
				'tab' => __( 'Label', 'lc-acf-integration' ),
			),
				array(
					'label' => __( 'Color', 'lc-acf-integration' ),
					'id' => 'css_label_color',
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-select span.label',
			...
			array(
				'label' => __( 'Label - Font Size', 'lc-acf-integration' ),
			...
			array(
				'label' => __( 'Label - Line Height', 'lc-acf-integration' ),
				'id' => 'css_res_t_label_line_height',
				'std' => '30',
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-select span.label',
			...
			array(
				'label' => __( 'Typography - Font Size', 'lc-acf-integration' ),
			...
			array(
				'label' => __( 'Typography - Line Height', 'lc-acf-integration' ),
			...
			array(
				'label' => __( 'Label - Line Height', 'lc-acf-integration' ),
				'id' => 'css_res_p_label_line_height',
				'std' => '30',
				'type' => 'slider',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-select span.label',
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-select">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_select' );

function lcacf_init_select() {
    return dslc_register_module( 'ACF_Select' );
}
