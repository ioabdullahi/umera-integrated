 ...
 * Module Class
 */
class ACF_Wysiwyg extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Wysiwyg';
		$this->module_title = __( 'Wysiwyg', 'lc-acf-integration' );
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'wysiwyg' );
			...
			$fields = lcacf_get_all_fields_by_group( 'wysiwyg' );
		...
		$dslc_options = array(
			...
			array(
				...
				array(
					...
					'affect_on_change_el' => '.lc-acf-module-text-wysiwyg',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg, .lc-acf-module-text-wysiwyg p',
			...
			array(
				...
				array(
					...
					'type' => 'slider',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-text-wysiwyg p',
					'affect_on_change_rule' => 'margin-top',
					'section' => 'styling',
					'tab' => __( 'Content', 'lc-acf-integration' ),
					'ext' => 'px',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg h1',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg h2',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg h3',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg h4',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg h5',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg h6',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg a',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg a:hover',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Links', 'lc-acf-integration' ),
			),
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg blockquote a',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Links', 'lc-acf-integration' ),
			),
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg blockquote a:hover',
				'affect_on_change_rule' => 'color',
				'section' => 'styling',
				'tab' => __( 'Links', 'lc-acf-integration' ),
			),
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-text-wysiwyg li',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Lists', 'lc-acf-integration' ),
				),
			...
			array(
				...
				array(
					...
					'type' => 'slider',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-text-wysiwyg ul,.lc-acf-module-text-wysiwyg ol',
					'affect_on_change_rule' => 'margin-top',
					'section' => 'styling',
					'tab' => __( 'Lists', 'lc-acf-integration' ),
					'ext' => 'px',
			...
			array(
				...
				'tab' => __( 'Lists', 'lc-acf-integration' ),
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg ul',
			...
			array(
				...
				'tab' => __( 'Lists', 'lc-acf-integration' ),
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg ol',
				'affect_on_change_rule' => 'list-style-type',
			),
			array(
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg input[type=text], .lc-acf-module-text-wysiwyg input[type=password], .lc-acf-module-text-wysiwyg input[type=number], .lc-acf-module-text-wysiwyg input[type=email], .lc-acf-module-text-wysiwyg input[type=tel], .lc-acf-module-text-wysiwyg textarea, .lc-acf-module-text-wysiwyg select',
				'affect_on_change_rule' => 'background-color',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'text_align',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg blockquote',
				'affect_on_change_rule' => 'text-align',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg input[type=submit], .lc-acf-module-text-wysiwyg button',
				'affect_on_change_rule' => 'background-color',
				'section' => 'styling',
			...
			array(
				...
				'type' => 'color',
				'refresh_on_change' => false,
				'affect_on_change_el' => '.lc-acf-module-text-wysiwyg input[type=submit]:hover, .lc-acf-module-text-wysiwyg button:hover',
				'affect_on_change_rule' => 'background-color',
				'section' => 'styling',
				'tab' => __( 'Buttons', 'lc-acf-integration' ),
			),
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_wysiwyg' );

function lcacf_init_wysiwyg() {
    return dslc_register_module( 'ACF_Wysiwyg' );
}
