 ...
 * Module Class
 */
class ACF_Date_Time_Picker extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Date_Time_Picker';
		$this->module_title = __( 'Date Time Picker', 'lc-acf-integration' );
		$this->module_icon = 'calendar-check-o';
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'date_time_picker' );
			...
			$fields = lcacf_get_all_fields_by_group( 'date_time_picker' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-date-time-picker',
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-date-time-picker">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_date_time_picker' );

function lcacf_init_date_time_picker() {
    return dslc_register_module( 'ACF_Date_Time_Picker' );
}
