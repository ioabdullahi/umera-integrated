 ...
 * Module Class
 */
class ACF_Time_Picker extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Time_Picker';
		$this->module_title = __( 'Time Picker', 'lc-acf-integration' );
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'time_picker' );
			...
			$fields = lcacf_get_all_fields_by_group( 'time_picker' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-time-picker',
	...
	function output( $options ) {
		...
		<div class="lc-acf-module-time-picker">
		<?php
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_time_picker' );

function lcacf_init_time_picker() {
    return dslc_register_module( 'ACF_Time_Picker' );
}
