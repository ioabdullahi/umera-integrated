 ...
 * Module Class
 */
class ACF_Email extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_Email';
		$this->module_title = __( 'Email', 'lc-acf-integration' );
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'email' );
			...
			$fields = lcacf_get_all_fields_by_group( 'email' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-email',
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-email a',
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-email a:hover',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-email span.prepend',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Prepend', 'lc-acf-integration' ),
				),
			...
			array(
				...
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-email span.append',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Append', 'lc-acf-integration' ),
				),
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_email' );

function lcacf_init_email() {
    return dslc_register_module( 'ACF_Email' );
}
