 ...
 * Module Class
 */
class ACF_URL extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'ACF_URL';
		$this->module_title = __( 'URL', 'lc-acf-integration' );
	...
	function options() {
		...
		if ( ! empty( $id ) ) {
			...
			$fields = lcacf_get_all_fields( $id, 'url' );
			...
			$fields = lcacf_get_all_fields_by_group( 'url' );
		...
		$dslc_options = array(
			...
			array(
				...
				'affect_on_change_el' => '.lc-acf-module-url',
			...
			array(
				...
				array(
					'label' => __( 'Color: Link', 'lc-acf-integration' ),
					'id' => 'css_typography_link_color',
					'std' => '',
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-url a',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
				array(
					...
					'type' => 'color',
					'refresh_on_change' => false,
					'affect_on_change_el' => '.lc-acf-module-url a:hover',
					'affect_on_change_rule' => 'color',
					'section' => 'styling',
					'tab' => __( 'Typography', 'lc-acf-integration' ),
				),
 ...
 * Register Module
 */
add_action( 'dslc_hook_register_modules', 'lcacf_init_url' );

function lcacf_init_url() {
    return dslc_register_module( 'ACF_URL' );
}
