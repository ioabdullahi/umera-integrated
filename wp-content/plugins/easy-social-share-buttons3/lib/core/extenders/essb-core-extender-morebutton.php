...
if (!function_exists('essb_generate_morebutton_code')) {
	function essb_generate_morebutton_code($button_style, $social_networks, $social_networks_order, $salt, $position,
		...
		if (($user_set_morebutton_func == '2' || $user_set_morebutton_func == '3' || $user_set_morebutton_func == '4' || $user_set_morebutton_func == '5')) {				
			...
			$more_social_networks = $share_button_exist && $user_set_morebutton_func == '3' ? essb_core_helper_generate_list_networks_without_share($listAllNetworks) : essb_core_helper_generate_list_networks($listAllNetworks);
			$more_social_networks_order = essb_core_helper_generate_network_list();	
			
			if ($share_button_exist && $user_set_morebutton_func == '3') $more_social_networks_order = $more_social_networks;
			...
			if ($user_set_morebutton_func == '3') {
			    if ($share_button_exist) {
			        //$more_social_networks = essb_core_helper_networks_after_share($more_social_networks);
			        
			       
			    }
			    
				else if (in_array('more', $more_social_networks) || in_array('share', $more_social_networks)) {
