...
if (essb_option_bool_value('instagram_widget') && !essb_option_bool_value('deactivate_module_instagram')) {
...
if (!essb_option_bool_value('deactivate_module_pinterestpro')) {
    include_once (ESSB3_CLASS_PATH . 'networks/class-pinterest-pro-tools.php');
}
...
if (! essb_options_bool_value('deactivate_module_shareoptimize')) {
    if (essb_options_bool_value('opengraph_tags') || essb_options_bool_value('twitter_card')) {
        ...
        include_once (ESSB3_MODULES_PATH . 'social-share-optimization/class-seo-plugin-integrations.php');
...
if (!essb_options_bool_value('deactivate_module_clicktochat')) {
    if (essb_option_bool_value('click2chat_activate') || essb_option_bool_value('click2chat_woo_activate') || essb_option_bool_value('click2chat_manual_activate')) {
...
if (essb_sanitize_option_value('css_mode') == 'light') {
    include_once (ESSB3_PLUGIN_ROOT . 'lib/core/helpers/helpers-lightstyles.php');
}
...
if (!essb_option_bool_value('deactivate_module_pinterestpro') && essb_option_bool_value('pinpro_follow_box')) {
    include_once (ESSB3_MODULES_PATH . 'pinterest-pro-follow/class-pinterest-pro-follow.php');
}
...
if (essb_option_bool_value('activate_novashare_bridge')) {
    include_once (ESSB3_INTEGRATIONS_PATH . 'novashare.php');
}

if (essb_option_bool_value('activate_hubbub_bridge')) {
    include_once (ESSB3_INTEGRATIONS_PATH . 'hubbub.php');
}
