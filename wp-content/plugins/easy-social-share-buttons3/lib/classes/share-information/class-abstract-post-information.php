...
abstract class ESSB_Post_Information {
    ...
    private function otherplugin_integration_value ($key = '') {
        ...
        if (essb_option_bool_value('activate_novashare_bridge')) {
            $value = $this->novashare_integration_value($key);
        }
        
        if (essb_option_bool_value('activate_hubbub_bridge')) {
            $value = $this->hubbub_integration_value($key);
        }
    ...
    private function integration_is_running() {
        return essb_option_bool_value('activate_sw_bridge') || essb_option_bool_value('activate_ss_bridge') || 
            essb_option_bool_value('activate_ms_bridge') || essb_option_bool_value('activate_novashare_bridge') 
            || essb_option_bool_value('activate_hubbub_bridge');
    }

    /**
     * Read previous set values in Hubbub
     *
     * @param string $key
     * @return string|NULL|unknown|string
     */
    private function hubbub_integration_value ($key = '') {
        if (essb_option_bool_value('activate_hubbub_bridge') && function_exists('essb_hubbub_custom_data')) {
            $sw_setup = essb_hubbub_custom_data();
    ...
    /**
     * Read previous set values in Novashare
     *
     * @param string $key
     * @return string|NULL|unknown|string
     */
    private function novashare_integration_value ($key = '') {
        if (essb_option_bool_value('activate_novashare_bridge') && function_exists('essb_novashare_custom_data')) {
            $sw_setup = essb_novashare_custom_data();
            return isset($sw_setup[$key]) ? $sw_setup[$key] : '';
        }
        else {
            return '';
