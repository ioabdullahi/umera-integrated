...
if (!function_exists('essb5_available_content_positions')) {
	function essb5_available_content_positions($wizard_mode = false) {
		...
		if (has_filter('essb_available_content_positions')) {
		    $essb_avaliable_content_positions = apply_filters('essb_available_content_positions', $essb_avaliable_content_positions);
		}
...
if (!function_exists('essb5_available_button_positions')) {
	function essb5_available_button_positions($wizard_mode = false) {
		...
		if (has_filter('essb_available_button_positions')) {
		    $essb_available_button_positions = apply_filters('essb_available_button_positions', $essb_available_button_positions);
		}
