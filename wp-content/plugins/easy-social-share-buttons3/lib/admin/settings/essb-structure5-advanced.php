...
ESSBOptionsStructureHelper::panel_start('advanced', 'integrate', esc_html__('Novashare', 'essb'), '', 'fa21 fa fa-plug', array("mode" => "toggle", 'state' => 'closed', "css_class" => "essb-auto-open"));
ESSBOptionsStructureHelper::field_switch('advanced', 'integrate', 'activate_novashare_bridge', esc_html__('Use previous data set in Novashare', 'essb'), esc_html__('If you use in past Novashare and you have a customizations made in social sharing than you can activate this option and allow plugin read all that stored values.', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
ESSBOptionsStructureHelper::panel_end('advanced', 'integrate');

ESSBOptionsStructureHelper::panel_start('advanced', 'integrate', esc_html__('Hubbub', 'essb'), '', 'fa21 fa fa-plug', array("mode" => "toggle", 'state' => 'closed', "css_class" => "essb-auto-open"));
ESSBOptionsStructureHelper::field_switch('advanced', 'integrate', 'activate_hubbub_bridge', esc_html__('Use previous data set in Hubbub', 'essb'), esc_html__('If you use in past Hubbub and you have a customizations made in social sharing than you can activate this option and allow plugin read all that stored values.', 'essb'), '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
ESSBOptionsStructureHelper::panel_end('advanced', 'integrate');
