...
$position_tabs = array(
	'<i class="ti-layout-width-default"></i>' . esc_html__('Inline (Content)', 'essb'),
...
if (function_exists('wc_get_product')) {
	if (!essb_option_bool_value('deactivate_method_woocommerce')) {
		...
		if (defined('ESSB_DM_WSB_PLUGIN_ROOT')) {
			...
			ESSBOptionsStructureHelper::field_func(
				$where_to_display,
				'positions|positions',
...
if (!essb_option_bool_value('activate_automatic_mobile')) {
	if (essb_option_bool_value('mobile_positions') && essb_option_value('functions_mode_mobile') != 'auto' && essb_option_value('functions_mode_mobile') != 'deactivate') {
		...
		ESSBOptionsStructureHelper::field_switch_panel($where_to_display, 'mobile|setup', 'mobile_disable_woocommerce_integrations', esc_html__('Disable WooCommerce content display methods on a mobile device', 'essb'), '', '', esc_html__('Yes', 'essb'), esc_html__('No', 'essb'));
	...
	if (essb_option_bool_value($location . '_activate')) {
		...
		if ($location != 'postbar' && $location != 'point') {
			...
			if (!essb_options_bool_value('deactivate_share_counters')) {
				ESSBOptionsStructureHelper::tabs_start($tab_id, $menu_id, 'position-styles-' . $location, array(
			...
			ESSBOptionsStructureHelper::holder_start($tab_id, $menu_id, 'essb-button-size-pickers', 'essb-button-size-pickers');

			ESSBOptionsStructureHelper::field_toggle($tab_id, $menu_id, $location . '_button_size', essb_generate_desktop_badge(), '', $select_values, '', '', 'button_size');

			ESSBOptionsStructureHelper::field_toggle($tab_id, $menu_id, $location . '_button_size_mobile', essb_generate_mobile_badge(), '', $select_values, '', '', 'button_size_mobile');
			...
			ESSBOptionsStructureHelper::tab_start($tab_id, $menu_id, 'position-styles-' . $location . (essb_options_bool_value('deactivate_share_counters') ? '-1' : '-2'));
...
function essb5_additional_deactivate_options()
{
	echo essb5_generate_code_advanced_settings_panel(
		...
		'',
		'',
		esc_html__('Advanced Deactivate', 'essb')
	);
}
