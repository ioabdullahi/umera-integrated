...
if (class_exists('ESSBControlCenter')) {
	...
	if (!essb_option_bool_value('deactivate_module_natives') ||
	        ...
	        !essb_option_bool_value('deactivate_module_clicktochat') ||
		...
		if (!essb_option_bool_value('deactivate_module_clicktochat') || !essb_option_bool_value('deactivate_module_clicktochat')) {
		    ESSBControlCenter::register_sidebar_section('chat', esc_html__('Chat', 'essb'), '', 'ti-comments');	
		}
