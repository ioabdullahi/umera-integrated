...
class ESSBAddonsHelper {
  ...
  "essb-subscribe-connector-mailjet": {
    "slug": "essb-subscribe-connector-mailjet",
    "name": "Mailjet Connector",
    "description": "Integrate subscribe forms in Easy Social Share Buttons for WordPress with Mailjet.",
    "price": "FREE",
    "page": "https://get.socialsharingplugin.com/?activationKey={activationKey}&domain={domain}&download=essb-subscribe-connector-mailjet",
    "requires": "7.0",
    "check": {
      "param": "ESSB_SUBSCRIBE_CONNECTOR_MAILJET",
      "type": "param"
    },
    "icon": "icon-subscribe",
    "actual_version": "1.0",
